...
use ndarray::{Array2, Array3, ArrayBase, Data, Ix2, Ix3, LinalgScalar};
use ndarray_linalg::Lapack;
use std::ops::AddAssign;

fn broad_dot_ix3_ix2<A, S, S2>(lhs: &ArrayBase<S, Ix3>, rhs: &ArrayBase<S2, Ix2>) -> Array3<A>
where
    A: Scalar + Lapack,
    S: Data<Elem = A>,
    S2: Data<Elem = A>,
...
fn broad_dot_ix2_ix3<A, S, S2>(lhs: &ArrayBase<S, Ix2>, rhs: &ArrayBase<S2, Ix3>) -> Array3<A>
where
    A: Scalar + Lapack,
    S: Data<Elem = A>,
    S2: Data<Elem = A>,
...
fn broad_dot_ix3_ix3<A, S, S2>(lhs: &ArrayBase<S, Ix3>, rhs: &ArrayBase<S2, Ix3>) -> Array3<A>
where
    A: Scalar + Lapack,
    S: Data<Elem = A>,
    S2: Data<Elem = A>,
...
fn quadratic_form_ix2_ix3_ix2<A, S1, S2, S3>(
...
where
    ...
    S3: Data<Elem = A>,
{
    let quadratic_output = broad_dot_ix2_ix3(lhs, &broad_dot_ix3_ix2(mid, rhs));
    quadratic_output
}

fn innovation_covariances_ix2<A: Scalar + Lapack>(
