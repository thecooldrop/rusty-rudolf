...
use cauchy::Scalar;
use ndarray::{Array2, Array3, ArrayBase, Axis, Data, Ix2, Ix3, azip, Zip, linalg::general_mat_mul};
use ndarray_linalg::{InverseC, Lapack, error::LinalgError};
use std::fmt::{Debug};


/// Multiplies each of the lhs matrices with rhs matrix
pub(in crate) fn broad_dot_ix3_ix2<A, S, S2>(lhs: &ArrayBase<S, Ix3>, rhs: &ArrayBase<S2, Ix2>) -> Result<Array3<A>, MatrixOperationError>
where
    A: Scalar + Lapack,
    S: Data<Elem = A>,
    S2: Data<Elem = A>,
...
pub(in crate) fn broad_dot_ix3_ix3<A, S, S2>(lhs: &ArrayBase<S, Ix3>, rhs: &ArrayBase<S2, Ix3>) -> Result<Array3<A>, MatrixOperationError>
where
    A: Scalar + Lapack,
    S: Data<Elem = A>,
    S2: Data<Elem = A>,
...
pub(in crate) fn quadratic_form_ix3_ix3_ix3<A, S1, S2>(inner: &ArrayBase<S1, Ix3>, outer: &ArrayBase<S2, Ix3>) -> Result<Array3<A>, MatrixOperationError>
where
    A: Scalar+Lapack,
    S1: Data<Elem=A>,
    S2: Data<Elem=A>
...
pub(in crate) fn update_states<A: Scalar+Lapack, S1: Data<Elem=A>>(states: &ArrayBase<S1, Ix2>, kalman_gains: &Array3<A>, innovations_negated: &Array3<A>) -> Result<Array3<A>, MatrixOperationError> {
...
pub(in crate) fn update_covariance<A: Scalar+Lapack, S1: Data<Elem=A>>(covariances: &ArrayBase<S1, Ix3>, kalman_gains: &Array3<A>, l_matrices: &Array3<A>) -> Result<Array3<A>, MatrixOperationError>{
...
pub(in crate) fn invc_all_ix3<A, S1>(matrices: &ArrayBase<S1, Ix3>) -> Result<Array3<A>, MatrixOperationError>
where
    A: Scalar + Lapack,
    S1: Data<Elem = A>,
{
